...
Source0  : https://download.qt.io/official_releases/qt/6.5/6.5.3/submodules/qtdoc-everywhere-src-6.5.3.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0 BSD-3-Clause CC-BY-SA-4.0 GFDL-1.3 GPL-3.0 OFL-1.1
...
%prep
%setup -q -n qtdoc-everywhere-src-6.5.3
cd %{_builddir}/qtdoc-everywhere-src-6.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696288366
mkdir -p clr-build
pushd clr-build
